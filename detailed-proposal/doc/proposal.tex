...
\TODO{cite Hindley milner if it does make sense.}
...
Luckily, version 8 of the Glasgow Haskell Compiler \cite{ghc8}\TODO{cite} has a very powerful type constraint satisfiability solver\cite{gadtsMeetTheirMatch}\TODO{cite}.
