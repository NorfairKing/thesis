...
The proof of concept succeeds in discovering possible properties and their type constraints.
Here are some excerpts of the output for the running example:
...
\begin{minted}{text}
  ...
  \x -> ((isPermutationOf x) (sort x))
  [ ([Int] -> ([Int] -> Bool)) ~ (t2 -> (t1 -> Bool))
  , a ~ t2
  , ([Int] -> [Int]) ~ (t6 -> t1)
  , a ~ t6
  ]
